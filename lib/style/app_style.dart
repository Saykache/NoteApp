...
class AppStyle {
  ...
  static Color mainColor = Color.fromARGB(255, 155, 7, 74); 
  static Color accentColor = const Color(0xFF0065FF);

  // Configurações para cartões de diferentes Cores
  ...
  // Configurações para stilo de texto
  ...
  static TextStyle dateTitle = GoogleFonts.nunito(fontSize: 13.0, fontWeight: FontWeight.w500);
}